...
class ModandroidplaylistsModule : public titanium::Proxy
{
public:
	explicit ModandroidplaylistsModule(jobject javaObject);
...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> getSongs(const v8::Arguments&);
