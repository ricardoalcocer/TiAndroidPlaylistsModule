...
// This proxy can be created by calling Modandroidplaylists.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=ModandroidplaylistsModule.class)
